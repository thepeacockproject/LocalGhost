...
{
    public static class v1_0_sniper
    {
        public static void addVersions()
        {
            HitmanVersion.addVersion("1.0.1.0_dx11_sniper", 0x5B31107D, v1_0_1_dx11_sniper);
            HitmanVersion.addVersion("1.0.1.0_dx12_sniper", 0x5B311189, v1_0_1_dx12_sniper);
        }

        private static HitmanVersion v1_0_1_dx11_sniper = new HitmanVersion()
        {
        ...
        private static HitmanVersion v1_0_1_dx12_sniper = new HitmanVersion()
        {
